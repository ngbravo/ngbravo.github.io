<?php
	...
	*/
	...
	$contact_email = 'nikolasbra@gmail.com'; //Example : Youremail.com
	...
	//Success Message
	define('SUCCESS_MESSAGE', '<h4 class="form_thanks">¡Gracias! Te responderé a la brevedad</h4>');
	
	//Error message when message can't send
	define('ERROR_MESSAGE', '<h4 class="form_thanks">¡Ups! Algo salió mal. Intenta nuevamente.</h4>');
